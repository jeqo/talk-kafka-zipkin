...
public class Tweet extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public void put(int field$, Object value$) {
    switch (field$) {
    case 0: text = (CharSequence)value$; break;
    case 1: username = (CharSequence)value$; break;
    case 2: lang = (CharSequence)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Tweet>
    ...
    public Tweet build() {
      try {
        ...
        record.text = fieldSetFlags()[0] ? this.text : (CharSequence) defaultValue(fields()[0]);
        record.username = fieldSetFlags()[1] ? this.username : (CharSequence) defaultValue(fields()[1]);
        record.lang = fieldSetFlags()[2] ? this.lang : (CharSequence) defaultValue(fields()[2]);
        return record;
      } catch (Exception e) {
